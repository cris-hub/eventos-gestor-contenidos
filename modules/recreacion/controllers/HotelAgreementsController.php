...
use app\modules\recreacion\models\HotelAgreementsSearch;
 ...
 */
class HotelAgreementsController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new HotelAgreementsSearch();
    ...
    {
        if (($model = HotelAgreements::findOne($id)) !== null) {
            return $model;
        }
